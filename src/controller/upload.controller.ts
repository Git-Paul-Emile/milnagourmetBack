...
class UploadController {
  ...
  async uploadLogoImage(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async uploadTestimonialImage(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async uploadFruitImage(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async uploadSauceImage(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async uploadCerealeImage(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async uploadAvatarToastImage(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  listImages = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const getImagesFromDir = (dirPath: string, basePath: string) => {
