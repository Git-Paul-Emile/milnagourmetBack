...
import { createDeliveryPersonSchema, updateDeliveryPersonSchema } from '../validator/deliveryPerson.schema.js';
...
router.post('/', requireAdmin, validateResource(createDeliveryPersonSchema), deliveryPersonController.create);
router.put('/:id', requireAdmin, validateResource(updateDeliveryPersonSchema), deliveryPersonController.update);
