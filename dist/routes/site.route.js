...
import { updateBrandingSchema, updateAvatarToastSchema, updateContactSchema, updateSocialMediaSchema, createTestimonialSchema, updateTestimonialSchema, updateHeroSchema, updateCatalogSectionSchema, updateStoreHoursSchema } from '../validator/site.schema.js';
const router = Router();
