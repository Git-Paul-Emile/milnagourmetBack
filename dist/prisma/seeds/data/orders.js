export const ordersData = [
    // NOVEMBRE 2025
    {
        ...
        "items": [
            {
                "productId": "cremeux-simple",
                "quantity": 2,
                "price": 600
            },
            {
                "productId": "liquide-vanille",
                "quantity": 1,
                "price": 2000
            }
        ],
    ...
    },
    {
        ...
        "customerAddress": "Libreville, Gabon",
        "status": "LIVREE",
        "totalAmount": 6000,
        "deliveryFee": 2000,
        "notes": "Préférer livraison en journée",
    ...
    },
    {
        ...
        "updatedAt": "2025-11-05T18:45:00.000Z",
        "deliveryZoneId": "3",
        "deliveryPersonId": "3",
        "items": [
            {
                "productId": "cremeux-cereales",
                "quantity": 1,
                "price": 1000
            }
        ],
    ...
    },
    {
        ...
        "updatedAt": "2025-11-10T17:30:00.000Z",
        "deliveryZoneId": "1",
        "deliveryPersonId": "2",
        "items": [
            {
    ...
    },
    {
        ...
        "updatedAt": "2025-11-12T13:20:00.000Z",
        "deliveryZoneId": "3",
        "deliveryPersonId": "3",
        "items": [
            {
    ...
    },
    {
        ...
        "updatedAt": "2025-11-16T18:45:00.000Z",
        "deliveryZoneId": "1",
        "deliveryPersonId": "1",
        "items": [
            {
    ...
    },
    {
        ...
        "deliveryFee": 1000,
        "notes": "",
        "createdAt": "2025-11-22T13:20:00.000Z",
        ...
        "customCreations": [
            {
                ...
                "quantity": 1,
                "price": 3900,
                "fruits": ["Fraise", "Banane", "Mangue", "Papaye"],
                "sauces": ["Caramel", "Miel", "Chocolat"],
                "cereales": ["Granola", "Muesli"]
            }
        ]
    },
    {
        "id": "order-014",
        "userId": "user-004",
        "customerName": "Binta Camara",
        "customerPhone": "+221778889900",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 2400,
        "deliveryFee": 1000,
        ...
        "updatedAt": "2025-11-26T17:20:00.000Z",
        "deliveryZoneId": "2",
        "deliveryPersonId": "2",
        "items": [
            {
    ...
    },
    {
        "id": "order-015",
        "userId": "user-005",
        "customerName": "Modou Niang",
        "customerPhone": "+221772223344",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 5700,
        "deliveryFee": 1200,
        ...
        "updatedAt": "2025-11-28T13:15:00.000Z",
        "deliveryZoneId": "3",
        "deliveryPersonId": "3",
        "items": [
            {
                "productId": "liquide-coco",
                "quantity": 2,
                "price": 2800
            }
        ],
    ...
    },
    {
        "id": "order-016",
        "userId": "user-001",
        "customerName": "Rokhaya Diallo",
        "customerPhone": "+221776667788",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 3300,
        "deliveryFee": 1000,
    ...
    // DÉCEMBRE 2025
    {
        "id": "order-017",
        "userId": "user-002",
        "customerName": "Youssouf Sarr",
        "customerPhone": "+221773334455",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 4900,
        "deliveryFee": 1200,
    ...
    },
    {
        ...
        "updatedAt": "2025-12-05T17:45:00.000Z",
        "deliveryZoneId": "4",
        "deliveryPersonId": "5",
        "items": [
            {
    ...
    },
    {
        "id": "order-020",
        "userId": "user-005",
        "customerName": "Aissatou Diop",
        "customerPhone": "+221771116667",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 3600,
        "deliveryFee": 1000,
        "notes": "",
        "createdAt": "2025-12-07T09:20:00.000Z",
        "updatedAt": "2025-12-07T13:10:00.000Z",
        "deliveryZoneId": "1",
        "deliveryPersonId": "1",
        "items": [
            {
    ...
    },
    {
        "id": "order-021",
        "userId": "user-001",
        "customerName": "Samba Gueye",
        "customerPhone": "+221772227778",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 5300,
        "deliveryFee": 1200,
        ...
        "customCreations": [
            {
                ...
                "quantity": 1,
                "price": 4400,
                "fruits": ["Fraise", "Banane", "Mangue", "Ananas", "Papaye"],
                "sauces": ["Caramel", "Miel", "Chocolat"],
                "cereales": ["Granola", "Muesli"]
            }
        ]
    },
    {
        "id": "order-022",
        "userId": "user-002",
        "customerName": "Fatima Sow",
        "customerPhone": "+221773338889",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 2900,
        "deliveryFee": 1000,
    ...
    },
    {
        "id": "order-023",
        "userId": "user-003",
        "customerName": "Oumar Thiam",
        "customerPhone": "+221774449990",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 6400,
        "deliveryFee": 1200,
    ...
    },
    {
        "id": "order-024",
        "userId": "user-004",
        "customerName": "Nafissatou Diallo",
        "customerPhone": "+221775550001",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 4100,
        "deliveryFee": 1000,
        ...
        "updatedAt": "2025-12-15T15:20:00.000Z",
        "deliveryZoneId": "1",
        "deliveryPersonId": "1",
        "items": [
            {
    ...
    },
    {
        ...
        "updatedAt": "2025-12-19T17:45:00.000Z",
        "deliveryZoneId": "3",
        "deliveryPersonId": "3",
        "items": [
            {
    ...
    },
    {
        ...
        "deliveryFee": 1000,
        "notes": "",
        "createdAt": "2025-12-21T10:20:00.000Z",
        "updatedAt": "2025-12-21T14:10:00.000Z",
        "deliveryZoneId": "1",
        "deliveryPersonId": "2",
        "items": [
            {
    ...
    },
    {
        ...
        "updatedAt": "2025-12-23T12:45:00.000Z",
        "deliveryZoneId": "3",
        "deliveryPersonId": "3",
        "items": [
            {
    ...
    },
    {
        ...
        "deliveryFee": 1200,
        "notes": "",
        "createdAt": "2025-12-27T13:15:00.000Z",
    ...
    },
    {
        ...
        "updatedAt": "2025-12-29T13:20:00.000Z",
        "deliveryZoneId": "2",
        "deliveryPersonId": "2",
        "items": [
            {
    ...
    },
    {
        "id": "order-032",
        "userId": "user-002",
        "customerName": "Aissatou Gueye",
        "customerPhone": "+221777778899",
        "customerAddress": "Dakar, Sénégal",
        "status": "LIVREE",
        "totalAmount": 4800,
        "deliveryFee": 1200,
        ...
        "updatedAt": "2025-12-31T14:50:00.000Z",
        "deliveryZoneId": "3",
        "deliveryPersonId": "3",
        "items": [
            {
    ...
    // Commandes avec statuts variés pour décembre
    {
        "id": "order-033",
        "userId": "user-003",
        "customerName": "Souleymane Ba",
        "customerPhone": "+221771234567",
        "customerAddress": "Dakar, Sénégal",
        ...
        "updatedAt": "2025-12-30T09:30:00.000Z",
        "deliveryZoneId": "1",
        "items": [
            {
                "productId": "cremeux-simple",
    ...
    },
    {
        ...
        "updatedAt": "2025-12-31T15:05:00.000Z",
        "deliveryZoneId": "3",
        "items": [
            {
                "productId": "liquide-bissap",
